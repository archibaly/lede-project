...
#ifndef SYSCONFDIR
#define DEFAULT_CONFIGFILE "/etc/portal/portal.conf"
#else
#define DEFAULT_CONFIGFILE SYSCONFDIR"/portal/portal.conf"
#endif
#define DEFAULT_DAEMON 1
#define DEFAULT_DEBUGLEVEL LOG_WARNING
#define DEFAULT_MAXCLIENTS 20
#define DEFAULT_GATEWAY_IPRANGE "0.0.0.0/0"
#define DEFAULT_GATEWAYNAME "Portal"
...
#define DEFAULT_WEBROOT "/etc/portal/htdocs"
#define DEFAULT_SPLASHPAGE "portal.html"
#define DEFAULT_INFOSKELPAGE "infoskel.html"
#define DEFAULT_IMAGESDIR "images"
#define DEFAULT_PAGESDIR "pages"
#define DEFAULT_AUTHDIR "portal_auth"
#define DEFAULT_DENYDIR "portal_deny"
...
#define DEFAULT_NDSCTL_SOCK "/var/run/ptlctl.sock"
#define DEFAULT_INTERNAL_SOCK "/var/run/ptlctl.sock"
...
typedef struct {
	...
	char *ptlctl_sock;		/**< @brief ptlctl path to socket */
	...
	char *webroot;			/**< @brief Directory containing portal pages, etc. */
	char *portalpage;		/**< @brief Name of main portal page */
